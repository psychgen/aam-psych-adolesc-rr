...
--phenoFile /ess/p471/cluster/projects/aam_RR/GWAS/input_files/pheno_gwas_odd_tr.txt \
--bsize 200 \
--strict \
--pred /ess/p471/cluster/projects/aam_RR/GWAS/output_files/odd_pred.list \
--out ${OUTM}/odd_step2