...
--phenoFile /ess/p471/cluster/projects/aam_RR/GWAS/input_files/pheno_gwas_cd_tr.txt \
--bsize 200 \
--strict \
--pred /ess/p471/cluster/projects/aam_RR/GWAS/output_files/cd_pred.list \
--out ${OUTM}/cd_step2