...
--phenoFile /ess/p471/cluster/projects/aam_RR/GWAS/input_files/pheno_gwas_adhd_tr.txt \
--bsize 200 \
--strict \
--pred /ess/p471/cluster/projects/aam_RR/GWAS/output_files/adhd_pred.list \
--out ${OUTM}/adhd_step2