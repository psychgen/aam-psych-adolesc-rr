...
--phenoFile /ess/p471/cluster/projects/aam_RR/GWAS/input_files/pheno_gwas_anx_tr.txt \
--bsize 200 \
--strict \
--pred /ess/p471/cluster/projects/aam_RR/GWAS/output_files/anx_pred.list \
--out ${OUTM}/anx_step2